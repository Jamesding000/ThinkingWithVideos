...
export dataset_json_path=[data/actnet/train_set_grpo_new_12k_cutsrc_diff.json,data/charades/train_set_grpo_cutsrc_diff.json,data/Video-R1-data/train_set_grpo_01_src_exist_video_diff.json,data/Video-R1-data/train_set_grpo_image80k_src_exist_diff.json,data/nextgqa/train_set_grpo_cutsrc_diff.json,data/rextime/train_set_grpo_exist_cutsrc_diff_4k7.json,data/vidchapters/train_set_grpo_cutsrc_diff_exist_7k4_len256.json]
export dataset_video_base=[data/actnet/video_14400frames_fps2,data/charades/video_14400frames_fps2,data/Video-R1-data/video_14400frames_fps2,data/Video-R1-data,data/nextgqa/video_14400frames_fps2,data/rextime/video_14400frames_fps2,data/vidchapters/video_14400frames_fps2]
