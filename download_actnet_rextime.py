...
def get_video_ids_rextime(limit):
    ...
    out_dir = "/data/user_data/jamesdin/data/rextime"
...
def get_video_ids_actnet(limit):
    val_data = Path("/data/user_data/jamesdin/data/actnet/actnet_val_1.json")
    ...
    out_dir = "/data/user_data/jamesdin/data/actnet"
    if not os.path.exists(out_dir):
        os.makedirs(out_dir, exist_ok = True)
...
if __name__ == "__main__":
    ...
    if args.type == "rextime":
        ...
        ids_file = Path("/data/user_data/jamesdin/data/rextime/rextime_video_ids.txt")
        video_root = Path("/data/user_data/jamesdin/data/rextime/rextime_videos")
    else:
        get_video_ids_actnet(limit)
        ids_file = Path("/data/user_data/jamesdin/data/actnet/actnet_video_ids_500.txt")
        video_root = Path("/data/user_data/jamesdin/data/actnet/actnet_videos")
    
    main(ids_file, video_root, args)
    
"""
python download_actnet_rextime.py --type=rextime
python download_actnet_rextime.py --type=actnet
"""