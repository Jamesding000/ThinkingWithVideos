...
#SBATCH --output=/home/jamesdin/logs/vc-data-%j.out
#SBATCH --error=/home/jamesdin/logs/vc-data-%j.err
...
export VIDCHAPTERS_TMPDIR=${TMP_DIR}/job_${SLURM_JOB_ID}/vidchapters
mkdir -p "$VIDCHAPTERS_TMPDIR"
echo "Using VIDCHAPTERS_TMPDIR=$VIDCHAPTERS_TMPDIR"
...
python download_and_extract_frames.py \
    ...
    --output-dir ${data_dir} \
    --tmp-video-dir $VIDCHAPTERS_TMPDIR \
    --fps 2 \
    --max-frames 14400 \
    --size 224
