#!/usr/bin/bash
#SBATCH --job-name=verl-rl-tool-qwen3-bs8
...
#SBATCH --output=/home/jamesdin/logs/verl-rl-tool-qwen3-%j.out
#SBATCH --error=/home/jamesdin/logs/verl-rl-tool-qwen3-%j.err
