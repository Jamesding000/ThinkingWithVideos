...
#SBATCH --output=/home/jamesdin/logs/eval_rextime-%j.out
#SBATCH --error=/home/jamesdin/logs/eval_rextime-%j.err
...
for model_path in "${model_paths[@]}"; do
    ...
    echo "=========================================="
    echo "Starting Rextime evaluation"
    ...
    echo "Log file: ${SAVE_PATH}/${DATE}_eval_rextime_step${step}.log"
    echo "=========================================="
done