...
#SBATCH --mem=250GB                  # max cpu memory, given the memory leakage issue, can run for 600 steps
...
python3 -m verl.trainer.main_ppo \
    ...
    data.custom_cls.path=verl/utils/dataset/rl_dataset_multi_turn.py \
    data.custom_cls.name=RLHFDatasetMultiTurn \
    data.sampler.class_path=verl/utils/dataset/rl_sampler_multimodal.py \
