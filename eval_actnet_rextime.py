...
# python eval_actnet_rextime.py \
#   --model-path models/Qwen2.5-VL-7B-Instruct \
#   --video-root /home/yiqunh/ThinkingWithVideos/actnet/actnet_videos \
#   --validation-file processed_data/actnet/actnet_val_1.json \
#   --output-dir outputs/actnet_eval/qwen2_5_vl_7b
