...
class ActorRolloutRefWorker(Worker):
        ...
        with init_context(), warnings.catch_warnings():
            ...
            if freeze_vision_tower:
                if hasattr(actor_module, "visual"):
                    ...
                    print("Vision tower is freeze, set to not trainable.")
                else:
                    print("No vision tower found.")
            else:
                print("Vision tower is open, set to trainable.")
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            ...
            from verl.workers.rollout.vllm_rollout import vllm_mode, vLLMRollout, vLLMRolloutMultiTurn, vLLMRolloutMultiTurnSync
            ...
            if vllm_mode == "customized":
                ...
                elif self.config.rollout.mode == "multi_turn":
                    vllm_rollout_cls = vLLMRolloutMultiTurn
                elif self.config.rollout.mode == "multi_turn_sync":
                    vllm_rollout_cls = vLLMRolloutMultiTurnSync
                elif self.config.rollout.mode == "async":
                    vllm_rollout_cls = vLLMAsyncRollout
                else:
                    raise NotImplementedError("vllm_rollout mode must be 'sync', 'multi_turn' or 'async'")
    ...
    def generate_sequences(self, prompts: DataProto):
        # Support all hardwares
        timing_generate = {}
        with _timer("generate_sequences_before", timing_generate):
        ...
        with _timer("rollout_sharding_manager", timing_generate):
        ...
        with _timer("generate_sequences_after", timing_generate):
