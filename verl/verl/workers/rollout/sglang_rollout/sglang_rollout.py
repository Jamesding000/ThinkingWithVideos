...
class SGLangRollout(BaseRollout):
    ...
    def _init_inference_engine(self, trust_remote_code, actor_module, port):
        ...
        print(f'>>>>>> in sglang_rollout.py, _init_inference_engine: nnodes={nnodes}, port={port}')
        if nnodes > 1:
            ip = get_ip()
            ...
            dist_init_addr = None
        print(f'>>>>>> out sglang_rollout.py, _init_inference_engine: nnodes={nnodes}, port={port}, dist_init_addr={dist_init_addr}')
